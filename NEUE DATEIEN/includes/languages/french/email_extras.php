...
define('OFFICE_SENT_TO', '<strong>À:</strong>');
define('OFFICE_EMAIL_TO', '<strong>À courriel:</strong>');
...
define('SEND_EXTRA_CREATE_ACCOUNT_EMAILS_TO_SUBJECT', '[NOUVEAU COMPTE]');

define('SEND_EXTRA_GV_CUSTOMER_EMAILS_TO_SUBJECT', '[CERTIFICAT-CADEAU]');
define('SEND_EXTRA_NEW_ORDERS_EMAILS_TO_SUBJECT', '[NOUVELLE COMMANDE]');
define('SEND_EXTRA_CC_EMAILS_TO_SUBJECT', '[INFORMATIONS SUPPLÉMENTAIRES SUR LES CARTES DE CRÉDIT] #');

// Low Stock Emails
define('EMAIL_TEXT_SUBJECT_LOWSTOCK', 'AVERTISSEMENT : Niveau minimum de stock en dessous de la limite inférieure');
define('SEND_EXTRA_LOW_STOCK_EMAIL_TITLE', 'Rapport d\'inventaire: ');