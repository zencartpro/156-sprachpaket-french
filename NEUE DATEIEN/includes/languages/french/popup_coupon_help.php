...
define('HEADING_COUPON_HELP','Coupon action Aide');
...
define('TEXT_ALLOW','permettre');
define('TEXT_DENY','interdire');
define('TEXT_ALLOWED', ' (permis)');
define('TEXT_DENIED', ' (pas permis)');

define('TEXT_NO_CAT_TOP_ONLY_DENY', '<p>Ce coupon promotionnel n\'est valable que pour certains articles.');
define('TEXT_NO_CAT_RESTRICTIONS', '<p>Ce coupon action est valable pour toutes les catégories.</p>');
define('TEXT_NO_PROD_RESTRICTIONS', '<p>Ce coupon promotionnel est valable pour tous les articles.</p>');
define('TEXT_NO_PROD_SALES', '<p>Ce coupon promotionnel n\'est pas valable pour les offres spéciales.</p>');

// gift certificates cannot be purchased with Discount Coupons
define('TEXT_COUPON_GV_RESTRICTION','Les coupons promotionnels ne peuvent pas être utilisés pour acheter des certificats-cadeaux.');
define('TEXT_COUPON_GV_RESTRICTION_ZONES', 'Aucun bon d\'action ne peut être échangé avec cette adresse de facturation.');