...
define('HEADER_ALT_TEXT', 'Propulsé par Zen Cart 1.5.6 - version allemande');
...
define('HEADER_SEARCH_DEFAULT_TEXT', 'Entrer le terme de recherche');
define('SEARCH_DEFAULT_TEXT', 'Rechercher');