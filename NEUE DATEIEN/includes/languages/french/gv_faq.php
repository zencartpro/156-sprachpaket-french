...
define('TEXT_INFORMATION', '<a name="Top"></a>
  <a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=1','NONSSL').'">Comment commander ' . TEXT_GV_NAMES . '</a><br />
  <a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=2','NONSSL').'">Comment puis-je expédier ' . TEXT_GV_NAMES . '</a><br />
  <a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=3','NONSSL').'">Faire du shopping avec ' . TEXT_GV_NAMES . '</a><br />
  <a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=4','NONSSL').'">Échanger de ' . TEXT_GV_NAMES . '</a><br />
  <a href="'.zen_href_link(FILENAME_GV_FAQ,'faq_item=5','NONSSL').'">En cas de problèmes</a><br />
');
switch ($_GET['faq_item']) {
  case '1':
define('SUB_HEADING_TITLE','Comment commander ' . TEXT_GV_NAMES);
define('SUB_HEADING_TEXT', 'Vous pouvez commander des ' . TEXT_GV_NAMES . ' comme n\'importe quel autre article de notre boutique. Vous pouvez payer avec les méthodes de paiement traditionnelles. Une fois le ' . TEXT_GV_NAME . ' commandé, sa valeur sera créditée sur votre compte ' . TEXT_GV_NAME . ' personnel. Votre panier d\'achat personnel affichera le montant échangé sur votre compte de Chèque cadeau. De plus, un lien vers votre ' . TEXT_GV_NAME . ' apparaîtra, que vous pourrez ensuite envoyer par courriel à vos amis et connaissances');
  ...
  break;
  case '2':
define('SUB_HEADING_TITLE','Comment puis-je expédier ' . TEXT_GV_NAMES);
define('SUB_HEADING_TEXT','Pour envoyer un ' . TEXT_GV_NAME . ', il vous suffit de vous rendre sur notre page d\'expédition de ' . TEXT_GV_NAME . '. Vous trouverez le lien dans votre panier personnel. Lors de l\'envoi d\'un ' . TEXT_GV_NAME . ', vous devez fournir les informations suivantes :
...
Vous recevrez également une brève notification par courriel. Afin d\'éviter toute erreur, veuillez vous assurer que vous avez entré toutes les informations correctement. Vous aurez également la possibilité de vérifier vos détails plus tard avant d\'envoyer le bon d\'achat.');
  ...
  break;
  case '3':
define('SUB_HEADING_TITLE','Faire du shopping avec ' . TEXT_GV_NAMES);
define('SUB_HEADING_TEXT','Si votre compte de ' . TEXT_GV_NAME . ' a un solde, vous pouvez l\'utiliser pour acheter d\'autres articles dans notre boutique. Un champ de saisie supplémentaire apparaîtra pendant le processus de paiement.<br />
Veuillez saisir le montant que vous souhaitez retirer de votre compte de ' . TEXT_GV_NAME . '. Si la valeur de la commande dépasse le solde de votre compte ' . TEXT_GV_NAME . ', vous pouvez choisir le mode de paiement souhaité pour la différence. Si la valeur de votre commande est inférieure au solde de votre compte de ' . TEXT_GV_NAME . ', le solde de votre compte de ' . TEXT_GV_NAME . ' sera bien entendu conservé pour vos prochains achats.');
  ...
  break;
  case '4':
define('SUB_HEADING_TITLE','Échanger de ' . TEXT_GV_NAMES);
define('SUB_HEADING_TEXT','Lorsque vous recevez un ' . TEXT_GV_NAME . ' par email, vous serez informé de l\'expéditeur, de la valeur du ' . TEXT_GV_NAME . ' et d\'un court message de l\'expéditeur. L\'e-mail contient également le ' . TEXT_GV_NAME . ' avec le ' . TEXT_GV_REDEEM . ' d\'achat. Nous vous recommandons d\'imprimer votre ' . TEXT_GV_NAME . ' pour une utilisation ultérieure.
...
define('SUB_HEADING_TEXT','Pour tout renseignement concernant notre système de ' . TEXT_GV_NAME . ', veuillez prendre contact par E-mail avec  <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS .'">' . STORE_OWNER_EMAIL_ADDRESS . '</a> Veuillez vous assurer de donner autant d\'informations que possible dans le courriel.');

  break;
  default:
define('SUB_HEADING_TITLE','');
define('SUB_HEADING_TEXT','Veuillez sélectionner votre sujet, vous avez aussi des questions.');
