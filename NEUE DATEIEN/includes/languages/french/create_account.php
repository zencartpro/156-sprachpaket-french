...
// greeting salutation
define('EMAIL_SUBJECT', 'Bienvenue à la ' . STORE_NAME . '!');
define('EMAIL_GREET_MR', 'Cher Monsieur %s,' . "\n\n");
define('EMAIL_GREET_MS', 'Chère Madame %s,' . "\n\n");
define('EMAIL_GREET_NONE', 'Chère Madame/Monsieur %s' . "\n\n");

// First line of the greeting
define('EMAIL_WELCOME', 'Bienvenue à la <strong>' . STORE_NAME . '</strong>.');
