...
define('BUTTON_ADD_TO_CART_ALT', 'Ajouter à mon panier d\'achats');
define('BUTTON_ADD_ADDRESS_ALT', 'Ajouter une adresse');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT', 'Ajouter les articles sélectionnés au panier');
...
define('BUTTON_REDEEM_ALT', 'Encaissement');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Retour à la liste d\'articles');
define('BUTTON_REVIEWS_ALT', 'Vers les cotes d\'écoute');
define('BUTTON_SEARCH_ALT', 'Rechercher');
define('BUTTON_SEND_ALT', 'Envoyer maintenant');
define('BUTTON_SEND_ANOTHER_ALT', 'Envoyer un autre bon d\'achat');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Envoyer un bon d\'achat');
...
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Description du produit');
define('BUTTON_MORE_REVIEWS_ALT', 'Autres évaluations');
define('BUTTON_VIEW_ALL_ALT', 'Tout afficher');
