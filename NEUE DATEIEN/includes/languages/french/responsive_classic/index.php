...
define('TEXT_INFORMATION', 'Définissez ici votre texte personnel. Vous pouvez éditer ce texte dans <strong>/includes/ languages/french/responsive_classic/index.php</strong>.');
